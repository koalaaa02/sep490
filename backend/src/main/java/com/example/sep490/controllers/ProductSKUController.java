...
public class ProductSKUController {
    ...
    @Autowired
    private ProductSKUService addressService;
    ...
    public ResponseEntity<?> getProductSKUes(
        ...
        return ResponseEntity.ok(addressService.getProductSKUs(page, size, sortBy, direction));
    }
    ...
    public ResponseEntity<?> getProductSKUById(@PathVariable Long id) {
        ...
        return ResponseEntity.ok().body(addressService.getProductSKUById(id));
    }
    ...
    public ResponseEntity<?> createProductSKU(@RequestBody ProductSKURequest address) {
        ...
        return ResponseEntity.ok().body(addressService.createProductSKU(address));
    }
    ...
    public ResponseEntity<?> updateProductSKU(@PathVariable Long id, @RequestBody ProductSKURequest address) {
        ...
        return ResponseEntity.ok().body(addressService.updateProductSKU(id, address));
    }
    ...
    public ResponseEntity<?> deleteProductSKU(@PathVariable Long id) {
        ...
        try {
            addressService.deleteProductSKU(id);
