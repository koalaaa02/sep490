...
const OrderDetail = ({ order }) => {
  ...
  return (
    <div className="d-flex p-2 border border-black  mt-2 mb-5 rounded shadow-sm">
            ...
            <tbody>
              {order.products.map((p) => (
                <tr className="">
                  ...
                  <td className="w-20 text-center">{p.price}</td>
      ...
      <div className="order-button w-25 p-2 text-center d-flex flex-column">
        ...
        <div className="my-auto">
          <div className="bg-warning-subtle w-80 mx-auto mt-5 px-10 py-5 rounded border">
            <p className="fs-6 fw-bold">Tổng tiền</p>
            <div className="border border-dark px-5 py-1">3000303</div>
          </div>
          <div className="my-5 "> Chờ xét duyệt</div>
          <div className="my-5">Huỷ yêu cầu</div>
        </div>
      </div>
    </div>
  );
